...
az vm create --resource-group $iaas_rg --authentication-type password --name IaaSVM1 --image UbuntuLTS  --admin-password $jumpbox_admin --admin-username $jumpbox_admin_password 
az vm create --resource-group $iaas_rg --authentication-type password --name IaaSVM2 --image UbuntuLTS  --admin-password  --admin-username $jumpbox_admin $jumpbox_admin_password
